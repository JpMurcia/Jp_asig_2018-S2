                                            ...
                                            <a href="#">
                                                <div class="card card-profile" style="width: 300px; height: 400px">
                                                    <div class="card-header card-avatar  ">
                                                        <a href="#pablo">
                                                            <img runat="server"  src="../../Content/assetsAdministracion/img/giecom.jpg" />
                                                        </a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        ...
                        <h5 class="title">¿Que es ViewGroup?</h5>
                    <%--     <asp:Label runat="server" ID="pregunta" CssClass="title" Text="¿Que es ViewGroup?" >
                        </asp:Label>--%>

                      
                        <asp:Label runat="server" ID="descripcion" CssClass="description" Text="" >
                        </asp:Label>
